...
//classe transcreve obj -> JSON / salva em localStorage
class Bd {
    ...
    recuperarTodosRegistros() {
       ...
       //recuperar todas as despesas localStorage
       for(let i = 1; i <= id; i++){
        //recuperar a despesa
...
function cadastrarDespesa() {
    ...
    let despesa = new Despesa(
        ...
        document.getElementById('modal_btn').ATTRIBUTE_NODE.innerHTML = 'Voltar';
        ...
        document.getElementById('modal_btn').ATTRIBUTE_NODE.innerHTML = 'Voltar e corrigir';
